...
func WalkAffectedTargets(context *Context, revBefore LabelledGitRev, targets TargetsList, targetsSuffix string, includeDifferences bool, callback WalkCallback) error {
	...
	beforeMetadata, afterMetadata, err := FullyProcess(context, revBefore, revAfter, targets, targetsSuffix)
	if err != nil {
